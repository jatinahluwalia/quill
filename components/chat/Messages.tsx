...
const Messages = ({ fileId }: Props) => {
  ...
  return (
    <div className="scrollbar-thumb-blue scrollbar-track-blue-lighter scrollbar-thumb-rounded scrollbar-w-2 flex max-h-[calc(100vh-3.5rem-7rem)] flex-1 flex-col-reverse gap-4 overflow-y-auto border-zinc-200 p-3">
